        ...
        <?php   
				if (isset($_GET['submit'])) {
					...
					if (!empty($cari)) {
						...
						$sql = "SELECT * FROM `listservis` WHERE Nama LIKE '%$cari%' OR  Alamat LIKE '%$cari%' OR  Telp LIKE '%$cari%' OR  TanggalService LIKE '%$cari%' OR  TipeMobil LIKE '%$cari%' OR  TahunMobil LIKE '%$cari%' OR  PlatMobil LIKE '%$cari%' OR  Keluhan LIKE '%$cari%' OR Keluhan LIKE '%$cari%'   ";
					}else {
						// perintah tampil semua data
				...
				while($data = mysqli_fetch_array($query)){
					...
					echo "<td>".$data['ID']."</td>";
					 ...
					 echo "<td><a href=BookingEditMS.php?id=".$data['ID'].">EDIT</td>";
